...
public class test {
    public static void main(String[] args) {
        //death by fire
            ...
            Tile hornetNest = new Tile(1, false, false, false, null, null, null, null);
            // hornetNest.buildNest();
            Tile tile1 = new Tile(2, false, false, false, null, null, null, null);
            Tile tile2 = new Tile(3, false, false, false, null, null, null, null);
            hornetNest.createPath(tile1, new Tile());
            tile1.createPath(tile2, hornetNest);
            // We check that if a hornet dies from fire on tile1 that it does not move to tile2
            Hornet dyingHornet = new Hornet(tile1, 1, 0);
